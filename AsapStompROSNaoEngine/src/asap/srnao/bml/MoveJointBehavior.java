...
/**
 * Moves a joint to the specified angle over a set period of time
 * @author davisond
 */
public class MoveJointBehavior extends NaoBehaviour
{
    ...
    public MoveJointBehavior(String bmlId, XMLTokenizer tokenizer) throws IOException
    {
        super(bmlId);
        readXML(tokenizer);
    }
     ...
     */
    private static final String XMLTAG = "moveJoint";
    ...
    {
        if (name.equals("jointName") || name.equals("angle"))
        {
            return true;
        }

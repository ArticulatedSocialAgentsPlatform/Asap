...
public class PicturePlannerTest
{
    ...
    public void setup()
    {
        naoPlanner = new NaoPlanner(fbManager, mockPictureBinding, planManager);
        plannerTests = new PlannerTests<TimedNaoUnit>(naoPlanner, bbPeg);
    ...
    public void testAdd() throws IOException, BehaviourPlanningException
    {
        ...
        TimedNaoUnit tpu = naoPlanner.resolveSynchs(bbPeg, beh, sacs); 
        List<SyncAndTimePeg> syncAndPegs = naoPlanner.addBehaviour(BMLBlockPeg.GLOBALPEG, beh, sacs, tpu);

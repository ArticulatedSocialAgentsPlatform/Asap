...
public class EnvironmentLoadingTest
{
    ...
    {
        BMLSchedulerAssembler asm = new BMLSchedulerAssembler("id1", new BMLParser(), NullFeedbackManager.getInstance()
                ,bbm , mockClock,pegBoard);
        String str = "<BMLScheduler>"+
                     "<SchedulingHandler class=\"asap.scheduler.BMLBandTSchedulingHandler\" " +
                     		"schedulingStrategy=\"hmi.elckerlyc.scheduler.SortedSmartBodySchedulingStrategy\"/>"+
                     "</BMLScheduler>";

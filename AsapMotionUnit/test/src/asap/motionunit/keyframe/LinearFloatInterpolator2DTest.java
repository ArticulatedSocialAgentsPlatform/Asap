...
public class LinearFloatInterpolator2DTest
{
    ...
    public void setup()
    {
        ...
        KeyFrame kf1 = new KeyFrame(0.2,new float[]{2,3});
        KeyFrame kf2 = new KeyFrame(0.8,new float[]{3,4});
        KeyFrame kf3 = new KeyFrame(1,new float[]{4,5});
    ...
    {
        KeyFrame kf = interp2d.interpolate(0.2);
    ...
    {
        KeyFrame kf = interp2d.interpolate(0.1);

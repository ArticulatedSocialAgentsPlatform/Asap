...
public class Branch
{
    ...
    public float getMassOffset(float q[], int qIndex,float result[])
    {
        connector.getWorldTransform(connectorTransform);
        return idBranch.getMassOffset(connectorTransform, q, qIndex, result);
    }
}

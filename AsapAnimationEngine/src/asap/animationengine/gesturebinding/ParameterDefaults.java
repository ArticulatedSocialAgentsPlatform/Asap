...
public class ParameterDefaults extends XMLStructureAdapter
{
    ...
    public ParameterDefaults(ParameterDefaultsHandler s)
    {
        spec = s;
    }
    ...
    public void decodeContent(XMLTokenizer tokenizer) throws IOException
    {
        while (tokenizer.atSTag())
        {
            ...
            if (tag.equals(MotionUnitParameterDefault.xmlTag())) 
            {
                MotionUnitParameterDefault mupc = new MotionUnitParameterDefault();
                mupc.readXML(tokenizer);
                spec.addParameterDefault(mupc);
            }
        }
    }

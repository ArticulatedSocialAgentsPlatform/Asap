...
public class GuidingSequenceTest
{
    ...
    public void before()
    {
        ...
        gs.addGuidingStroke(new LinearGStroke(GStrokePhaseID.STP_PREP, new TPConstraint(0.2, 1), Vec3f.getZero()));
        gs.addGuidingStroke(new LinearGStroke(GStrokePhaseID.STP_PREP, new TPConstraint(0.4, 1), Vec3f.getVec3f(1,2,3)));
        gs.addGuidingStroke(new LinearGStroke(GStrokePhaseID.STP_PREP, new TPConstraint(0.6, 1), Vec3f.getVec3f(2,3,4)));
    }
    ...
    {
        List<GuidingStroke> gSub = ImmutableList.<GuidingStroke>of(new LinearGStroke(GStrokePhaseID.STP_PREP, new TPConstraint(0.11, 1), Vec3f.getVec3f(0,1,1)), 
                new LinearGStroke(GStrokePhaseID.STP_PREP, new TPConstraint(0.12, 1), Vec3f.getVec3f(1,0,1)));
    ...
    {
        List<GuidingStroke> gSub = ImmutableList.<GuidingStroke>of(new LinearGStroke(GStrokePhaseID.STP_PREP, new TPConstraint(0.21, 1), Vec3f.getVec3f(0,1,1)), 
                new LinearGStroke(GStrokePhaseID.STP_PREP, new TPConstraint(0.22, 1), Vec3f.getVec3f(1,0,1)));

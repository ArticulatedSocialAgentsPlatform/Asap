...
public class LMPWristPosTest extends AbstractTimedPlanUnitTest
{
    ...
    public void testUpdateTimingStrokeStartConstraints() throws TimedPlanUnitPlayException
    {
        ...
        assertEquals(0.8+0.2+tau.getStrokeDuration()+tau.getRetractionDuration(), tau.getTime("end"), TIMING_PRECISION);        
    }
    ...
    {
        TimedAnimationUnit tau = setupPlanUnit(fbManager, BMLBlockPeg.GLOBALPEG, "bml1", "beh1");
        assertThat(tau.getAvailableSyncs(), IsIterableContainingInAnyOrder.containsInAnyOrder("start", "ready", 
                "strokeStart", "stroke", "strokeEnd", "relax","end"));
    }
}

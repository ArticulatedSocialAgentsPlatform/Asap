...
import asap.srnao.lipsync.TimedPictureUnitLipSynchProvider;
...
public class TimedPictureUnitLipSynchProviderLoader implements LipSynchProviderLoader {
    	...
    	throws IOException 
    {
        ...
        StompROSNaoEmbodiment pe = null;
        for (Loader e : requiredLoaders) {
            if (e instanceof PictureEngineLoader) {
                pel = (PictureEngineLoader) e;
            }
            if (e instanceof StompROSNaoEmbodiment) {
                pe = (StompROSNaoEmbodiment) e;
            }
        }

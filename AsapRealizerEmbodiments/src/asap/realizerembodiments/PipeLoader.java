...
/** A PipeLoader can adapt the realizerport of the BMLRealizer loaded into a AsapRealizerEmbodment. PipeLoaders are added to the pipe in the order that they are specified in the XML */
public interface PipeLoader {
	 ...
	 * @throws IOException */
	void readXML(XMLTokenizer theTokenizer, String id, String vhId,
